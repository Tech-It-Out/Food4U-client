    ...
    if (isModal && !user) {
      return (
        ...
        >
          ...
          <Modal.Body>
            <p>{'Please click on the "Expedited Sign-In" button if you don\'t want to create your own account and do not care for customer data persistence across sessions.'}</p>
